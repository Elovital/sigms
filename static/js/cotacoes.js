...
export async function renderCotacoes(container) {
  ...
  state.multi.segs    = [0,1,2].map(() => newSegMulti());
  state.at.segs       = [0,1,2].map(() => newSegAT());
...
function buildMultiLayout(segList) {
  ...
  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:24px" id="seg-cards-multi">
    ${[0,1,2].map(i => buildSegCardMulti(i, segList)).join('')}
  </div>
  <div class="card" style="margin-bottom:24px">
    <div class="card-header" style="background:var(--gray-900);color:white;border-radius:8px 8px 0 0">
      <span class="card-title" style="color:white;font-size:14px;font-weight:700">📋 Tabela Comparativa</span>
...
function buildATLayout(segList) {
  ...
  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:24px" id="seg-cards-at">
    ${[0,1,2].map(i => buildSegCardAT(i, segList)).join('')}
  </div>
  <div class="card" style="margin-bottom:24px">
    <div class="card-header" style="background:var(--gray-900);color:white;border-radius:8px 8px 0 0">
      <span class="card-title" style="color:white;font-size:14px;font-weight:700">📋 Tabela Comparativa</span>
